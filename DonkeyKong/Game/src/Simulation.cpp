...
void Simulation::nextStep(){
    ...
    if ((moveDirection == "Jump" && !jm->groundContact ) || (moveDirection == "Up" && !jm->groundContact && !jm->ladderContact) || moveDirection == "Up" && !jm->ladderContact || moveDirection == "Down" && jm->groundContact)
        moveDirection = "";
